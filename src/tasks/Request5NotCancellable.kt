...
suspend fun loadContributorsNotCancellable(service: GitHubService, req: RequestData): List<User>=  GlobalScope.async  {
    var deferreds: List<Deferred<List<User>>>{
